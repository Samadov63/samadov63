    ...
    class Program
    {
        public class Date
        {
            ...
            public int Day
            {
                ...
                set
                {
                    if (value < 1 || value > NDaysMonthYear(month, year))
            ...
            int NDaysMonthYear(int m, int y)
            {
                    ...
                    case 1:
                        ...
                        MonthERR:
                            try
                            {
                                ...
                                record.DateBirth.Month = int.Parse(Console.ReadLine());
                            }
                            catch (Exception ex)
                            {
                                Console.WriteLine(ex.Message);
                        ...
                        YearERR:
                            try
                            {
                                ...
                                record.DateBirth.Year = int.Parse(Console.ReadLine());
                            }
                            catch (Exception ex)
                            {
                                Console.WriteLine(ex.Message);
                        ...
                        DayERR:
                            try
                            {
                                ...
                                record.DateBirth.Day = int.Parse(Console.ReadLine());
                            }
                            catch (Exception ex)
                            {
                                Console.WriteLine(ex.Message);
